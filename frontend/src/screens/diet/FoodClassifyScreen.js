...
export default function RecognitionScreen() {
  ...
  const { hasPermission, hdPhoto, ldPhoto, takePicture, cleanPhoto } = useCamera()
  const { ready, predictions, classifyImage, cleanPredictions } = useFoodModel()
